...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="${'http://47.112.22.169/' + goods.gimage}" jqimg="images/img04.jpg" width="350">
                </div>
                <div id="spec-n5">
                    <div class=control id="spec-left">
                        <img src="${'http://47.112.22.169/' + goods.gimage}" />
                    </div>
                    <div id="spec-list">
                        <ul class="list-h">
        ...
        <div class="shop_goods_show_right">
            <ul>
                <li>
                    <strong style="font-size:14px; font-weight:bold;">${goods.gtitle}</strong>
                </li>
                <li>
                    <label>价格：</label>
        ...
        <script>
            function addcart() {
                ...
                //跳转到添加购物车的请求
                location.href = "http://10.36.142.17:8088/cart/add?gid="+gid+"&gnumber"+gnumber;
            }
