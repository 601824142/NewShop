...
public class SearchServiceImpl implements ISearchService {
     ...
     */
    @Override
    public List<Goods> queryGoodsByIndexed(String keyword) {
        //新建一个查询索引库
        ...
        try {
            ...
            for (SolrDocument document : results) {
                ...
                //将属性转为一个商品对象
                Goods goods = new Goods(Integer.parseInt(id), gtitle, ginfo, gcount, gimage, 0, gprice);
                //加入集合中
                goodsList.add(goods);
            }
    ...
    public int insertGoodsIndexed(Goods goods) {
        ...
        solrDocument.setField("gtitle", goods.getGtitle());
